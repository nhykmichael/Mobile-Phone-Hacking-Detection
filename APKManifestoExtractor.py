...
class AppSelector:
    ...
    def on_select(self):
        ...
        apk_extractor.extract_AndroidManifest(self.selected_name)
...
class APKExtractor:
    def __init__(self, package_name_to_extract, saved_manifest):
        self.saved_manifest = saved_manifest
        self.package_name_to_extract = package_name_to_extract
    ...
    def extract_AndroidManifest(self, app_name: str):
...
#     save_xml_directory = r"C:\Android\DetectHacking\SAMSUNG_SM-A245F_RZ8W504QC5V"
#     apk_extractor = APKExtractor(package_name, save_xml_directory)
#     apk_extractor.extract_apk()
...
# details = APKDetailsExtractor('QR.apk')
