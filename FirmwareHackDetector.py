...
# save_permissions('C:\\Android', 'permissions.txt')


class System(IDeviceConnector, IScanner, IReportGenerator):
    def __init__(self):
    ...
    def scan(self, mobile_phone):
        # Code to scan the device
        firmware_analyser = FirmwareAnalyser()
        firmware_analyser.analyse(mobile_phone.firmware)

    def generate_report(self, analysis_results):
        # Code to generate a report
        report = HackingReport(analysis_results)
        self.notification_manager.send_report(report)
    ...
    # TODO
    def analyze_device_firmware(firmware):
        pass

    # TODO
    def adapt_dynamically(self):
        pass
...
print(extract_device_info('temp', 'device_properties.txt'))
...
# h = Hardware('temp\\device_properties.txt')
# # print(h.get_hardware_value())
# h.run()
...
#     puller = PullProp(directory)
#     puller.pull_and_save_properties()
...
# if __name__ == "__main__":
#     logcat_folder = "."
#     puller = PullLogcat(logcat_folder)
...
class FirmwareAnalyser(IAnalyser):
    ...
    def SELinuxStatus(self):  # ro.build.selinux
        ...
        if selinux_property == "1" and enforce_property == "1":
            ...
            messagebox.showinfo("SELinux Status Warning", "SELinux is set ENFORCING --> ACTIVE \n"
    ...
    def boot_state(self):
        ...
        try:
            with open(self.temp_file_path, 'r') as file:
                ...
                for line in file:
                    # Split the line based on ': ' to get property and its value
                    ...
                    if len(parts) == 2:
                        ...
                        if _prop == "ro.boot.verifiedbootstate":
                            # Based on the property's value, provide appropriate information
